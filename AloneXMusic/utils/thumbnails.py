...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"AloneXMusic/assets/AloneX.png")
        ...
        font = ImageFont.truetype("AloneXMusic/assets/font2.ttf", 45)
        ImageFont.truetype("AloneXMusic/assets/font2.ttf", 70)
        arial = ImageFont.truetype("AloneXMusic/assets/font2.ttf", 30)
        ImageFont.truetype("AloneXMusic/assets/font.ttf", 30)
