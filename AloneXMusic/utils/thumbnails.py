...
async def get_thumb(videoid):
    try:
        ...
        if 1==1:
            ...
            circle = Image.open("AloneXMusic/assets/circle.png")
            ...
            # fonts
            font1 = ImageFont.truetype('AloneXMusic/assets/font.ttf', 30)
            font2 = ImageFont.truetype('AloneXMusic/assets/font2.ttf', 70)
            font3 = ImageFont.truetype('AloneXMusic/assets/font2.ttf', 40)
            font4 = ImageFont.truetype('AloneXMusic/assets/font2.ttf', 35)

            image4 = ImageDraw.Draw(image2)
            image4.text((10, 10), "ALONE x MUSIC", fill="white", font = font1, align ="left") 
            image4.text((670, 150), "ALONE PLAYING", fill="white", font = font2, stroke_width=2, stroke_fill="white", align ="left") 
